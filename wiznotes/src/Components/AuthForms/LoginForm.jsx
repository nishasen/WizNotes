...
const LoginForm = () => {
  ...
  const setGuestLogin = () => {
    setForm({email: "nishasen@gmail.com", password: "nishaSen@123"})
  }
    ...
    <div className="main centered">
        <form className="auth-card" onSubmit={(e)=>submitHandler(e)}>
            ...
            <div className="card-pane dis-flex">
                ...
                <Link to="/forgot-password" className="btn-link text-black hover-red forgot-password">Forgot your password?</Link>
            </div>
